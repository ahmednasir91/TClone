namespace TwitterClone.Migrations
{
    ...
    public partial class Finalv12 : DbMigration
    {
        ...
        {
            DropIndex("UserFollowing", new[] { "User_Username1" });
            DropIndex("UserFollowing", new[] { "User_Username" });
            ...
            DropForeignKey("UserFollowing", "User_Username1", "Users");
            DropForeignKey("UserFollowing", "User_Username", "Users");
